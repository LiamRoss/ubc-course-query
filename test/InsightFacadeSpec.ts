...
describe("InsightFacadeSpec", function () {
    ...
    // Test 7
    // 
    it("Query with double grouping", function () {
        var id: string = "courses";
        this.timeout(10000);
        return insightFacade.addDataset(id, testBase64)
            .then(function (value: InsightResponse) {
                ...
                return insightFacade.performQuery(qr)
                    .then(function (value: InsightResponse) {
                        ...
                        expect(value.body).to.deep.equal({
                            ...
                            "result": [
                                {
                                    "courses_instructor": "abaci, uygar",
                                    "courses_dept": "phil"
                                },
                                {
                                    "courses_instructor": "adriasola munoz, ignacio alber",
                                    "courses_dept": "arth"
                                },
                                {
                                    "courses_instructor": "baillie, traci",
                                    "courses_dept": "eced"
                                },
                                {
                                    "courses_instructor": "bussiere, guillaume;monga, vishakha;racicot, leanne;stoodley, robin",
                                    "courses_dept": "chem"
                                },
                                {
                                    "courses_instructor": "maciejewski, wes",
                                    "courses_dept": "math"
                                },
                                {
                                    "courses_instructor": "maciejewski, wes;yilmaz, ozgur",
                                    "courses_dept": "math"
                                },
                                {
                                    "courses_instructor": "macintosh, lori",
                                    "courses_dept": "grsj"
                                },
                                {
                                    "courses_instructor": "ochoa, ignacio;whitney, laurel",
                                    "courses_dept": "geog"
                                },
                                {
                                ...
                                {
                                    "courses_instructor": "palacios, carolina;sork, thomas joda",
                                    "courses_dept": "adhe"
                                },
                                {
                                    "courses_instructor": "palacios, carolina;walker, judith",
                                    "courses_dept": "edst"
                                },
                                {
                                    "courses_instructor": "rozada, ignacio",
                                    "courses_dept": "math"
                                }
                            ]
                        });
